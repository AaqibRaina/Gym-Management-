...
<body>
	...
	<!-- Page top Section -->
	<section class="page-top-section set-bg" data-setbg="img/gallery/reg.jpg">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-8">
					...
					<form class="singup-form contact-form" method="post">
						<div class="row">
							...
							<div class="col-md-4">
						<input type="submit" id="submit" name="submit" value="Register Now" class="site-btn sb-gradient" style="color:#333">
